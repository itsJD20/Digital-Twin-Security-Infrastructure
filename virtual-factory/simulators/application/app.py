...
class App:
    ...
    def get_simulators(self, simulator_connector_client: ISimulatorConnectorClient,
        ...
        for name in self._config.get("simulator_names", []):
            simulators.append(self.get_simulator(name, simulator_connector_client, industrial_client, ditto_openplc_thing_id=self._config.get("ditto", {}).get("openplc_thing_id"), ditto_hmi_thing_id=self._config.get("ditto", {}).get("hmi_thing_id"))), #added line for HMI with openplc ID
        return simulators

    def get_simulator(self, name, simulator_connector_client,
                      industrial_conector_client: IIndustrialConnectorClient,
                      ditto_openplc_thing_id: Optional[str] = None,ditto_hmi_thing_id: Optional[str] = None) -> Simulator: #added line for HMI with openplc id
        ...
        simulator_config["ditto_openplc_thing_id"] = ditto_openplc_thing_id
        simulator_config["ditto_hmi_thing_id"] = ditto_hmi_thing_id #add line for HMI
